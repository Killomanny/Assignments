...
,ref=\thesection.\theenumi]
    ...
    \solution Download the following files and execute the  C program.
\begin{lstlisting}
wget https://github.com/Killomanny/Assignments/tree/main/Assignmets2.0/codes/4.1.c
wget https://github.com/Killomanny/Assignments/tree/main/Assignmets2.0/codes/source.h
\end{lstlisting}
Download the above files and execute the following commands
\begin{lstlisting}
...
\begin{lstlisting}
wget https://github.com/Killomanny/Assignments/tree/main/Assignmets2.0/codes/4.5cdf.py
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/Killomanny/Assignments/tree/main/Assignmets2.0/codes/4.5pdf.py
\end{lstlisting}
Download the above files and execute the following commands to produce Fig.\ref{fig:4.2}
\begin{lstlisting}
$ python3 4.5pdf.py
